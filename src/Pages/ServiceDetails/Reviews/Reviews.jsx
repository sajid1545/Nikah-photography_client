	...
	return (
		<div>
			<div className="flex items-center justify-center px-5 py-5 my-10">
				<div className="w-full mx-auto max-w-xl rounded-lg bg-white dark:bg-gray-800  px-5 pt-5 pb-10 text-gray-800 dark:text-gray-50 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
					...
					<div className="w-full mb-10">
						...
						<p className="text-sm text-gray-600 dark:text-gray-100 text-center px-5">{text}</p>
